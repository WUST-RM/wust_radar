...
#pragma once
#include "wust_radar_detect/camera/hik.hpp"
#include "wust_radar_detect/camera/video_player.hpp"
#include "wust_radar_detect/type/image.hpp"
#include "wust_radar_detect/type/type.hpp"
#include <wust_utils/logger.hpp>
#include <wust_utils/timer.hpp>
#include <yaml-cpp/yaml.h>

using FrameCallback = std::function<void(const ImageFrame&, bool)>;
class SingleCamera {
public:
    SingleCamera(
